...
function todo_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'todo' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'todo_custom_background_args', array(
...
function todo_scripts() {
	wp_enqueue_style( 'todo-style', get_stylesheet_uri() );

	// wp_enqueue_script( 'todo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . '/js/jquery.magnific-popup.min.js', array( 'jquery' ), '20150711', true );

	wp_enqueue_script( 'todo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20150116', true );

		wp_enqueue_script( 'mustache', get_template_directory_uri() . '/bower_components/mustache/mustache.js', array( 'jquery', 'underscore' ), '20150207', true );

		wp_enqueue_script( 'todo-app', get_template_directory_uri() . '/js/todo.js', array( 'jquery', 'underscore' ), '20150207', true );
